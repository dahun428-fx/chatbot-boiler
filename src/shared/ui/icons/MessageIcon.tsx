...
const MessageIcon = ({ fill = '#000', width = 24, height = 24 }: TIconProps) => {
  return (
    <svg
      width={`${width}`}
      height={`${height}`}
